...
%   of F is a feature frame and has the format [X;Y;S;TH;P], where X,Y
%   is the (fractional) center of the frame, S is the scale, TH is
%   the orientation (in radians) and P is the peak.
%
