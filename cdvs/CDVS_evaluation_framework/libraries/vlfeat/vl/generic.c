...
#if (defined(VL_OS_LINUX) || defined(VL_OS_MACOSX) || defined(ANDROID)) && defined(VL_COMPILER_GNUC)
...
/* definitions to use a lib instead of a DLL */
VL_EXPORT void vl_constructor_lib() 
{
	vl_constructor();
}

/* definitions to use a lib instead of a DLL */
VL_EXPORT void vl_destructor_lib() 
{
	vl_destructor();
}
