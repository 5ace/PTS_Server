...
alp_keypoint_orientations (double angles [4], int w, int h, double sigma,
 double x, double y, const float * grad_mod, const float * grad_ang, double magnif);
...
double x, double y, float * grad_mod, float * grad_ang, double magnif, float * src); 


/*
 * function added by TI: definitions for the ALP detector.
 * Just the interface changes, not the internal logic of vl_sift_calc_keypoint_descriptor()
 */
VL_EXPORT
void
alp_keypoint_descriptor(float * descr, double x, double y, double sigma, double angle0, int w, int h, const float * gradMod, const float * gradTheta, double magnif);
...
VL_EXPORT
void
alp_keypoint_descriptor_fast_mode(float * descr, double x, double y, double sigma, double angle0, int w, int h, float * gradMod, float * gradTheta, double magnif, float * src); 
